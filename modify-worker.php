	...
	if(isset($_GET['user_id'])){
		...
		if($result_set){
			if(mysqli_num_rows($result_set) == 1){
				...
				//user not found
				header('Location:worker_details.php? user_not_found');
				
			}
		}else{
			// query unsuccessful
			header('Location:worker_details.php? err=query_failed');
		}
	}
...
<body>
 ...
 <form action="modify-worker.php"  method="post" class="userform">
   ...
   <a href="worker-change-password.php?user_id=<?php echo$user_id; ?>" class="password"> Change Password </a>
   </p>
    <p>
   ...
   <br>
   <div class="backto"><span><a href="worker_details.php">Back </a></span></div><br>
