...
<body>
 ...
 <form action="product-order.php"  method="post" class="userform" >
   ...
   <h1>Add Order</h1>
   <p><lable for="">Accessories:</lable>
   <input type="text" name="accessories">
   </p>
    <tr>
   <p><lable for="">Boat Towed Meta:</lable>
   <input type="text" name="boat_towed_meta" >
   </p>
   <p>
   <lable for="">BRUSH-KART:</lable>
   <input type="text" name="brush_kart">
   </p>
    <p>
   <lable for="">Hand Held Metal:</lable>
   <input type="text" name="hand_held_metal">
   </p>
    <p>
   <lable for="">HYDRAULIC POWER:</lable>
   <input type="text" name="hydraulic_power">
   </p>
    <p>
   <lable for="">MINI BRUSH-KART:</lable>
   <input type="text" name="mini_brush_kart">
   </p>
    <p>
   <lable for="">Pali BilgeSafe:</lable>
   <input type="text" name="pali_bilgeSafe">
   </p>
    <p>
   <lable for="">Pingers and Pin:</lable>
   <input type="text" name="pingers_and_pin">
   </p>
   <p>
   <lable for="">Portable Cabin:</lable>
   <input type="text" name="portable_cabin">
   </p>
   <p>
   <lable for="">Remote Operated:</lable>
   <input type="text" name="remote_operated">
   </p>
   <p>
   <lable for="">Sonar Systems:</lable>
   <input type="text" name="sonar_systems">
   </p>
   <p>
   <lable for="">Underwater Came:</lable>
   <input type="text" name="underwater_came" id="">
   </p>
  <p>
   <lable for="">Total:</lable>
   <input type="text" name="total" id="">
   </p>
    <p>
   <lable for="">&nbsp</lable>
   <button type="submit" name="submit">confrom</button>
   </p>
