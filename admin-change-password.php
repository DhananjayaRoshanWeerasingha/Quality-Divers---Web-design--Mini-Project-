...
<body>
 ...
 <br>
 <br>
 <form action="admin-change-password.php"  method="post" class="userform">
   ...
   <p>
   <lable for="">Phone Number &nbsp :</lable>
   ...
   <a href="modify-admin.php?user_id=<?php echo$user_id; ?>" class="add"> Back </a>
