		...
		if($number == 0){
			$table2 .= '<h1>Data not Entered</h1>';
		                 ...
		                 $table1 .= '	<th style = "width: 200px">  First Name  </th>
		                 		...
		                 		<th style = "width: 100px">Is Delete</th>';
		           }
		   ...
		   while ($record = mysqli_fetch_assoc($resultser)){
		                      ...
		                      $table .= "<td><a href=\"services_edit.php?id={$record['id']}\" class='edit'>Edit</a></td>";
		                      $table .= "<td><a href=\"services_delete.php?id={$record['id']}\" onclick =\"return confirm('Are You Sure to remove this data?');\" class='delete'>Delete</a></td>";
		                      $table .= '</tr>';
		  
	}
  
	$table .= '</table>';
	  //$record = mysqli_fetch_assoc($resultser);
